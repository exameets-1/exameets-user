...
export default async function handler(req) {
  ...
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/admissions/${slug}`);
  if (!res.ok) {
    ...
    (
      <div
        style={{
          ...
          height: '630px',
          display: 'flex',
          backgroundImage: `url("https://www.exameets.in/images/og-images/admissions-og.png")`,
