        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-[#015990] dark:border-[#015990]">
          <div className="px-6 py-10">
            <div className="flex flex-col items-center mb-8">
              <FaCookieBite className="text-[#015990] dark:text-[#90cdf4] text-5xl mb-2 animate-bounce" />
            ...
            <div className="space-y-10">
              {sections.map((section, index) => {
                ...
                let icon = null;
                if (section.title.toLowerCase().includes('essential')) icon = <FaShieldAlt className="text-[#015990] dark:text-[#90cdf4] text-xl mr-2" />;
                if (section.title.toLowerCase().includes('analytics')) icon = <FaChartBar className="text-[#015990] dark:text-[#90cdf4] text-xl mr-2" />;
                if (section.title.toLowerCase().includes('advertising')) icon = <FaAd className="text-[#015990] dark:text-[#90cdf4] text-xl mr-2" />;
                if (section.title === 'Introduction') icon = <FaCookieBite className="text-[#015990] dark:text-[#90cdf4] text-xl mr-2" />;
            ...
            <div className="mt-12 flex flex-col items-center">
              <FaShieldAlt className="text-[#015990] dark:text-[#90cdf4] text-3xl mb-2" />
